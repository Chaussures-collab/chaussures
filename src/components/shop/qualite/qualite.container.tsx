...
export default function qualiteContainer() {
  return (
    <Container className='grid grid-rows-2 grid-cols-2 custom:grid-rows-1 custom:grid-cols-4 gap-4 justify-center items-center min-h-32 bg-primary-1 pb-2 pt-2'>
      ...
      <Qualite icon={<TbTruckDelivery className="text-4xl md:text-7xl text-gray-900" />} description1='Livraison rapide' description2='Produits sera livré en 72h '/>
